...
describe("Étant donné que je suis connecté en tant qu'administrateur", () => {
  describe("Quand je suis sur la page Tableau de bord, il y a des factures et une en attente", () => {
    test("Alors, les factures filtrées par statut en attente devraient renvoyer une facture.", () => {
      const filtered_bills = filteredBills(bills, "pending");
      expect(filtered_bills.length).toBe(1);
    });
  });
  describe("quand je suis sur le tableau de bord, il y a des factures, et il y a un accepté", () => {
    test("Alors, les factures filtrées par statut accepté devraient renvoyer une facture.", () => {
